...
func TestGetPathDataFromCSV(t *testing.T) {
	...
	tests := []struct {
		...
		{"pathImport", args{"../test_data/path.csv"}, []mat.Dense{*mat.NewDense(1, 3, []float64{-119012.4530400194053072482347, 6594719.2708460101857781410217, 1000.0000000000000000000000}), *mat.NewDense(1, 3, []float64{-112477.0871216368541354313493, 6594642.8338177241384983062744, 1000.0000000000000000000000}), *mat.NewDense(1, 3, []float64{-104680.5102365488564828410745, 6592731.9081105943769216537476, 1000.0000000000000000000000}), *mat.NewDense(1, 3, []float64{-102463.8364162787620443850756, 6588451.4345266232267022132874, 1000.0000000000000000000000}), *mat.NewDense(1, 3, []float64{-104107.2325244100502459332347, 6581954.2871223827823996543884, 1000.0000000000000000000000}), *mat.NewDense(1, 3, []float64{-136363.6584607544355094432831, 6575724.6693171421065926551819, 1000.0000000000000000000000}), *mat.NewDense(1, 3, []float64{-143548.7391195610107388347387, 6570985.5735634621232748031616, 1000.0000000000000000000000}), *mat.NewDense(1, 3, []float64{-144676.1852867673442233353853, 6570393.1865942524746060371399, 1000.0000000000000000000000})}},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
